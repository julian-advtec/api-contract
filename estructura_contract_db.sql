...
\restrict oIK2ZpGQRB16u58MirxVP8em85pnFthhdTriecITj5D57Acl8Olerqep84TEnOe
...
--
-- Name: asesor_gerencia_documentos_estado_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.asesor_gerencia_documentos_estado_enum OWNER TO postgres;

--
-- Name: auditor_documentos_estado_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.auditor_documentos_estado_enum OWNER TO postgres;

--
-- Name: contabilidad_documentos_estado_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.contabilidad_documentos_estado_enum OWNER TO postgres;

--
-- Name: contabilidad_documentos_tipo_causacion_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.contabilidad_documentos_tipo_causacion_enum OWNER TO postgres;

--
-- Name: contratos_estado_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.contratos_estado_enum OWNER TO postgres;

--
-- Name: contratos_tipo_contrato_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.contratos_tipo_contrato_enum OWNER TO postgres;

--
-- Name: documentos_contratista_tipo_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.documentos_contratista_tipo_enum OWNER TO postgres;

--
-- Name: documentos_contrato_tipo_documento_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.documentos_contrato_tipo_documento_enum OWNER TO postgres;

--
-- Name: modificaciones_contrato_tipo_modificacion_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.modificaciones_contrato_tipo_modificacion_enum OWNER TO postgres;

--
-- Name: obligaciones_estado_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.obligaciones_estado_enum OWNER TO postgres;

--
-- Name: polizas_estado_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.polizas_estado_enum OWNER TO postgres;

--
-- Name: polizas_tipo_poliza_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.polizas_tipo_poliza_enum OWNER TO postgres;

--
-- Name: rendicion_cuentas_documentos_estado_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.rendicion_cuentas_documentos_estado_enum OWNER TO postgres;

--
-- Name: rendicion_cuentas_historial_estadoanterior_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.rendicion_cuentas_historial_estadoanterior_enum OWNER TO postgres;

--
-- Name: rendicion_cuentas_historial_estadonuevo_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.rendicion_cuentas_historial_estadonuevo_enum OWNER TO postgres;

--
-- Name: signatures_type_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.signatures_type_enum OWNER TO postgres;

--
-- Name: tesoreria_documentos_estado_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.tesoreria_documentos_estado_enum OWNER TO postgres;
...
--
-- Name: asesor_gerencia_documentos; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.asesor_gerencia_documentos OWNER TO postgres;

--
-- Name: auditor_documentos; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.auditor_documentos OWNER TO postgres;
...
--
-- Name: contabilidad_documentos; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.contabilidad_documentos OWNER TO postgres;

--
-- Name: contratistas; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: documentos_contratista; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.documentos_contratista OWNER TO postgres;
...
--
-- Name: modificaciones_contrato; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.modificaciones_contrato OWNER TO postgres;
...
--
-- Name: rendicion_cuentas_documentos; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.rendicion_cuentas_documentos OWNER TO postgres;

--
-- Name: rendicion_cuentas_historial; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.rendicion_cuentas_historial OWNER TO postgres;
...
--
-- Name: supervisor_documentos; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.supervisor_documentos OWNER TO postgres;

--
-- Name: tesoreria_documentos; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.tesoreria_documentos OWNER TO postgres;
...
--
-- Name: documentos_contratista PK_32ffbd2279dc99f207accf0b56f; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: rendicion_cuentas_historial PK_5a22ba5b91d82eaedf040952482; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: documentos_contrato PK_5ad0116ce7977e1ac0c5f5e63b8; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: contabilidad_documentos PK_9ae4c584abee178829821aad445; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: auditor_documentos PK_9c11aa6a3764b61254d669fc7c9; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: rendicion_cuentas_documentos PK_9cba14a77972a044a496d7f520e; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: polizas PK_a8b0ccc8c8d114f91b29285a5bc; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: asesor_gerencia_documentos PK_af53fbabc3a52d4df900f7a454d; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: modificaciones_contrato PK_b37e5e987a0459bffbadae80b47; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: contratos PK_cfae35069d6f59da899c17ed397; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: obligaciones PK_d47d01afc38b9315370c995168f; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: supervisor_documentos PK_d4b82186c1973f3265157ceeea4; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: contratistas PK_d592ac068aa5239ac25c97f2812; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: tesoreria_documentos PK_d97b89f9656b8bfe65907b0c61a; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: bitacora_sistema PK_f2d2069630c06378cabe97ebe4a; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: signatures REL_c93e294b75e34b850a599a51e2; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: proveedores UQ_0b3fe0e7fcaa98c8c2de964effd; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: contratos UQ_288b05163da67d313b8facfd122; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: documentos UQ_2f033000b2926dd9b0f9a899cbe; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: contratistas UQ_3e8fb08343afcda5d33c2b5bc99; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: documentos UQ_49ab7b2d9154b9844f010164a03; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: supervisor_documentos UQ_4da1104a449d5e53a62f226c110; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: IDX_26a11717c1bc1e8ddce53cbaa9; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: IDX_54cb449f2b3a7b491f641d231e; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: IDX_5926433990173b5da69b46ee10; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: IDX_62908ddf0bfd328ec6eaa80c0d; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: IDX_6bbc2db4ae3192654d856b28dd; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: IDX_9a91c34e15480912085977dfb0; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: IDX_9f531a51f8c4aff9651419430d; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: IDX_a17dfc9c4661dee251c98cc388; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: IDX_c81a49688bd6cccd823266196b; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: IDX_d1ed8a7cd33a44f8b04a7687aa; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: tesoreria_documentos FK_005ebaaf04384d6212b5608c5be; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: modificaciones_contrato FK_012c1914d64cb38d93355fac627; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: polizas FK_1f611878e2f82ff45d86f71dab8; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: rendicion_cuentas_historial FK_2109181e2cc12203a790da7a26d; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: auditor_documentos FK_25688fd48438407788a50af136c; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: rendicion_cuentas_documentos FK_3487b3cdd4329d6773c1e95050d; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: asesor_gerencia_documentos FK_387a3fe231ae873efb25b7f5172; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: contabilidad_documentos FK_3ebe07a31c3da8eee46a13b3775; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: auditor_documentos FK_6c5c3bef1f267bfae9caecd807f; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: documentos FK_737f67a0358cb559977d2e48031; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: contratos FK_798b03c73c6cd83b3099aa3a057; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: documentos FK_7f806144b9abb3ebbabcbde4c0d; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: documentos_contratista FK_8115d1050b29bbd8aa54630fb9e; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: supervisor_documentos FK_8d87c6d06e7def49a488baa3eb1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: bitacora_sistema FK_9f531a51f8c4aff9651419430dd; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: rendicion_cuentas_documentos FK_a025165185c1d9a9636379ffcb6; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: documentos_contrato FK_aa17044a801ff295b8817aa517c; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: contabilidad_documentos FK_b185403de2ab32da0a9bca1f520; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: asesor_gerencia_documentos FK_b45c0967c7a608cef55d473a81a; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: obligaciones FK_bb68511392de83f758ad2652efe; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: signatures FK_c93e294b75e34b850a599a51e2c; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: bitacora_sistema FK_d1ed8a7cd33a44f8b04a7687aa0; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: rendicion_cuentas_historial FK_dfd3e4305fde779fab7484bf9cf; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: tesoreria_documentos FK_ef22537f5f497a9fb93fedf483b; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: supervisor_documentos FK_f078350f2b5cc373b8601605bce; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict oIK2ZpGQRB16u58MirxVP8em85pnFthhdTriecITj5D57Acl8Olerqep84TEnOe
